...
public class SearchFunctionPOI extends JFrame {
    ...
    private JCheckBox checkBox5 = new JCheckBox("Has Alibi");
    private JCheckBox checkBox6 = new JCheckBox("Is Suspect");
    private JTable result = new JTable();
    private JPanel panel = new JPanel();

    public SearchFunctionPOI() {
        new DataLoader();
    }

    public SearchFunctionPOI(String title) throws HeadlessException {
        super(title);
    ...
    private void searchPOIJSON() {

        //checking first name
        if (checkBox.isSelected()) {
            for (PersonOfInterest poi : personOfInterestList.getInstance().getPersonOfInterestList()) {
			    if(poi.getFirstName().equalsIgnoreCase(nameSearch.getText()))
			    {
				    int choice = JOptionPane.showConfirmDialog(null, poi.toString() + "\n\nDownload Information on this Person Of Interest?", "Search Results" , JOptionPane.YES_NO_OPTION);
                    if (choice == 0)
                    {
                        poi.Download(poi.toString(),poi.getFirstName()+poi.getLastName());
                        JOptionPane.showMessageDialog(null, "Download Successful", "Person Of Interest Download", JOptionPane.INFORMATION_MESSAGE);
                    }
        ...
        //checking last name
            ...
            for (PersonOfInterest poi : personOfInterestList.getInstance().getPersonOfInterestList()) {
			    if(poi.getLastName().equalsIgnoreCase(nameSearch.getText()))
			    {
                    int choice = JOptionPane.showConfirmDialog(null, poi.toString() + "\n\nDownload Information on this Person Of Interest?", "Search Results" , JOptionPane.YES_NO_OPTION);
                    if (choice == 0)
                    {
         ...
         //checking last name
            ...
            for (PersonOfInterest poi : personOfInterestList.getInstance().getPersonOfInterestList()) {
			    if(poi.getAge() == (Integer.parseInt(nameSearch.getText())))
			    {
                    int choice = JOptionPane.showConfirmDialog(null, poi.toString() + "\n\nDownload Information on this Person Of Interest?", "Search Results" , JOptionPane.YES_NO_OPTION);
                    if (choice == 0)
                    {
         ...
         //checking last name
            ...
            for (PersonOfInterest poi : personOfInterestList.getInstance().getPersonOfInterestList()) {
			    if(poi.getContactInfo().equalsIgnoreCase(nameSearch.getText()))
			    {
				    int choice = JOptionPane.showConfirmDialog(null, poi.toString() + "\n\nDownload Information on this Person Of Interest?", "Search Results" , JOptionPane.YES_NO_OPTION);
                    if (choice == 0)
                    {
         ...
         //checking last name
            ...
            for (PersonOfInterest poi : personOfInterestList.getInstance().getPersonOfInterestList()) {
			    if(poi.isHasAlibi().equalsIgnoreCase(nameSearch.getText()))
			    {
                    int choice = JOptionPane.showConfirmDialog(null, poi.toString() + "\n\nDownload Information on this Person Of Interest?", "Search Results" , JOptionPane.YES_NO_OPTION);
                    if (choice == 0)
                    {
         ...
         //checking last name
            ...
            for (PersonOfInterest poi : personOfInterestList.getInstance().getPersonOfInterestList()) {
			    if(poi.isSuspect().equalsIgnoreCase(nameSearch.getText()))
			    {
				    int choice = JOptionPane.showConfirmDialog(null, poi.toString() + "\n\nDownload Information on this Person Of Interest?", "Search Results" , JOptionPane.YES_NO_OPTION);
                    if (choice == 0)
                    {
