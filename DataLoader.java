...
=======
            UUID criminalId = UUID.fromString((String)criminalJSON.get(CRIME_CRIMINAL_ID));
>>>>>>> 76bcd9e5bed864f9e3e5e96f673f568193b8469e
    ...
    public static ArrayList <Criminal> loadCriminals(){
        ...
        try{
            ...
            for (int i = 0; i < criminalJSONList.size(); i++){
                ...
                criminal.add(new Criminal(criminalId, firstName, lastName, nickname, age, gender, ethnicity, contactInfo, linkedCrime, birthDate, eyeColor, hairDescription, facialHairDescription, height, weight, tattooDescription,  physicalMarksDescription, physicalBuild,  weaponDescription, complexion, clothingDescription,  vehicleDescription));
            }
    ...
    public static ArrayList <PersonOfInterest> loadPOI(){
        ...
        try{
            ...
            for (int i = 0; i < personofinterestJSONList.size(); i++){
                ...
                poi.add(new PersonOfInterest(personOfInterestId, suspectId, crimeId, firstName, lastName, age, contactInfo, isMinor, statement, hasAlibi, isSuspect));
            }
